...
<table width="75%" class="ruleTable indent">
    ...
    <tr><td class="ruleTableHeader"><fmt:message key="help.version.title"/></td><td class="ruleTableCell">${versionString} &ndash; ${buildDateString} [Commit: <a href="https://github.com/popeen/Booksonic-Sherlock/commit/${model.buildNumber}" target="_blank">${model.buildNumber}</a>]</td></tr>
    ...
    <tr><td class="ruleTableHeader"><fmt:message key="help.forum.title"/></td><td class="ruleTableCell"><a target="_blank" href="https://www.reddit.com/r/booksonic" rel="noopener noreferrer">Booksonic on Reddit</a> | <a href="https://github.com/popeen/Booksonic-Sherlock/issues" rel="noopener noreferrer">Issue tracker on GitHub.</a></td></tr>
</table>
